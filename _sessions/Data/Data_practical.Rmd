...
4. Lade die `tidyverse`, `haven`, und `readxl` Pakete. Falls eines der Pakete noch nicht installiert ist, installiere es zunächst mit `install.packages("PAKETNAME"s)`. 
