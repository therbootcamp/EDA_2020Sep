...
In diesem Practical wirst du üben mit `ggplot2` schöne Grafiken zu erstellen. 
...
2. Ergänze `geom_point()` mit `+` um Punkte zu plotten.
...
4. Ergänze `+ geom_smooth()` um eine angepasste Linie zu ergänzen.
